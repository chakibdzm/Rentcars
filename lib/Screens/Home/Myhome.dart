...
class _MyhomeState extends State<Myhome> {
  ...
  Widget build(BuildContext context) {
        ...
        Padding(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                child: Image.asset('assets/illustrations/image 29.png',),
                top: getHeight(40),
                left: getWidth(8),
              ),
              ...
              Positioned(child: Row(
                children: [
                  ...
                  SvgPicture.asset('assets/illustrations/bxs_gas-pump.svg'),
                  Text(' 50L',
                    style: TextStyle(
                      fontWeight: FontWeight.w400,
                      fontSize: getHeight(12),
    ...
    Positioned(child: Text('More Cars',
    style: TextStyle(
    color: Colors.grey,
    fontSize: getHeight(14),
    fontWeight: FontWeight.w400,
    ...
    Positioned(child: Text('Corolla Cross',
    style: TextStyle(
    fontWeight: FontWeight.w700,
    fontSize: getHeight(20),
    color: Colors.white,
    ...
    Positioned(child: SvgPicture.asset('assets/illustrations/Line 31.svg',
    width: getWidth(320),
    ),
    left: getWidth(25),
    top:getHeight(125),
    ...
    child: Center(child: Icon(Icons.arrow_forward_ios,color: Colors.black,size: getHeight(15),)),
